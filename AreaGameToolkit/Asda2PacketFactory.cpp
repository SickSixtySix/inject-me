// InjectMe
#include "Asda2PacketFactory.hpp"

using namespace InjectMe::Utils;
using namespace InjectMe::Network;

Asda2PacketFactory *Asda2PacketFactory::s_instance = nullptr;

Asda2PacketFactory::Asda2PacketFactory() {}

Asda2PacketFactory* Asda2PacketFactory::Instance()
{
	if (s_instance == nullptr)
		s_instance = new Asda2PacketFactory();

	return s_instance;
}

Buffer Asda2PacketFactory::MakePacket(sf::Uint16 packetID)
{
